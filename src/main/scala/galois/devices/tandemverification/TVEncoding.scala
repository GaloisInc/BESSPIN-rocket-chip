...
object TraceEnc {
  ...
  def te_op_microarch_state           = UInt(7, 8)
  ...
  def te_op_microarch_state_priv      = UInt(1, 8)
  def te_op_microarch_state_paddr     = UInt(2, 8)
  def te_op_microarch_state_eaddr     = UInt(3, 8)
  def te_op_microarch_state_data8     = UInt(4, 8)
  def te_op_microarch_state_data16    = UInt(5, 8)
  def te_op_microarch_state_data32    = UInt(6, 8)
  def te_op_microarch_state_data64    = UInt(7, 8)
  def te_op_microarch_state_mtime     = UInt(8, 8)
  def te_op_microarch_state_pc_paddr  = UInt(9, 8)
