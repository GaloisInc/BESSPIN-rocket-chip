...
import ssithchips.rocketchip.diplomaticobjectmodel.model._
...
/** An address space description.
  ...
  * @param permissions  the permission attributes of this space. See [[ssithchips.rocketchip.diplomacy.ResourcePermissions]].
  */
...
/** A serializable description of a device.
  * @param name         the resolved name of this device. See [[ssithchips.rocketchip.diplomacy.DeviceRegName]].
